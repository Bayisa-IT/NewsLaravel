			...
			<input type="hidden" name="pid" value="{{$data->pid}}">
				...
				<div class="col-sm-3">
					...
					<h4>Category  <span class="pull-right"><i class="fa fa-chevron-down"></i></span></h4><hr>
							...
							<p><label for="{{$cat->id}}">
								<input type="checkbox" name="category_id[]" value="{{$cat->id}}" @if(in_array($cat->id,$postcat)) checked
								@endif>
								{{$cat->title}}
							</label></p>
							...
							@endforeach
								...
								<p><label for="file" style="cursor: pointer;">Replace Feature Image</label></p>
